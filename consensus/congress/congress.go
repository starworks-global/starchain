...
func (c *Congress) VerifySeal(snap *Snapshot, header *types.Header) error {
	return c.verifySeal(snap, header, nil)
}
...
// from.
func (c *Congress) verifySeal(snap *Snapshot, header *types.Header, parents []*types.Header) error {
